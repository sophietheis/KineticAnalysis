...
DISTNAME = 'KineticAnalysis'
DESCRIPTION = '3D cell segmentation from label image'
MAINTAINER = 'Sophie THEIS'
MAINTAINER_EMAIL = 'sophiets13@gmail.com'
URL = 'https://github.com/sophietheis/KineticAnalysis'
LICENSE = 'MPL-2.0'
DOWNLOAD_URL = 'https://github.com/sophietheis/KineticAnalysis.git'
...
def write_version_py(filename='kinetic_analysis/_version.py'):
    cnt = """
...
if __name__ == "__main__":
    ...
    setup(
        ...
        package_data={'KineticAnalysis': files},
